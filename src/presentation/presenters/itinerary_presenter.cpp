...
ItineraryPresenter::ItineraryPresenter(IView& view, IInput& input, CreateEmptyItineraryUseCase& createItineraryUseCase,
                                       std::vector<std::unique_ptr<ItineraryItemFlow>> itemFlows,
                                       PaymentPresenter& paymentPresenter)
    : m_view(view), m_input(input), m_createItineraryUseCase(createItineraryUseCase), m_itemFlows(std::move(itemFlows)),
