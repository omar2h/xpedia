...
class HotelReservation : public Reservation
{
  ...
  public:
    ...
    [[nodiscard]] const std::string& getFromDate() const
    {
        return room.getDateFrom();
    }
    void setFromDate(const std::string& fromDate)
    {
        room.setDateFrom(fromDate);
    }

    [[nodiscard]] const std::string& getToDate() const
    {
        return room.getDateTo();
    }
    void setToDate(const std::string& toDate)
    {
        room.setDateTo(toDate);
    }
    ...
    void setCity(const std::string& city_)
    {
        city = city_;
    }
